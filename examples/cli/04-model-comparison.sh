...
rondo "Return two reliability risks for Python task runners." --model gemini:gemini-2.5-flash
echo
echo "[3/3] Grok HTTP path"
rondo "Return two reliability risks for Python task runners." --model grok:grok-3
echo
