...
|---------|------|-------------|
| 2.0 | 2026-06-05 | **Reqs 210-211: thinking output headroom** — adaptive thinking consumes max_tokens; max-effort + long task + 8K cap = empty body. Floor 32K for thinking models. Found by the FIRST real experiment-matrix run. |
