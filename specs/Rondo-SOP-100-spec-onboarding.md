# Rondo-SOP-100: Spec Onboarding Procedure
...
**Product:** Rondo
**Matches:** OB-SOP-100, Rondo-SOP-100 (Caliber), Rondo-SOP-100 (Rondo)
**References:** CORE-STD-012 (Requirement Readiness), CORE-STD-013 (TrackerData), CORE-STD-021 (MCP Standard)
**Depends on:** Rondo-STD-100, CORE-STD-000, Rondo-SOP-101, Rondo-STD-105, Rondo-REQ-100, Rondo-SOP-102, Rondo-STD-108, Rondo-STD-109, Rondo-IFS-102
...
- Universal standards (Rondo-STD-100 to Rondo-STD-105)
...
- Build process (Rondo-SOP-101 owns that)
...
| 003 | Universal standards (Rondo-STD-100 to Rondo-STD-105) match topic numbers across products | MUST |
...
|--------|----------|---------|---------|
| REQ | Requirements | What Rondo must do | Rondo-REQ-100 (Core), Rondo-REQ-101 (Automation) |
| STD | Standards | How code must be written | Rondo-STD-108 (Error Resilience), Rondo-STD-109 (Configuration) |
| SOP | Procedures | How to do things (step-by-step) | Rondo-SOP-101 (Build & Run), Rondo-SOP-102 (Release) |
| IFS | Interfaces | How Rondo connects to other products | Rondo-IFS-100 (Claude CLI), Rondo-IFS-102 (OB Integration) |
| VER | Verification | How to prove specs are implemented | Rondo-VER-100 (Verification Matrix) |
...
**Rondo-specific examples:** Rondo-STD-108 (Error Resilience), Rondo-STD-109 (Configuration), Rondo-STD-110 (Concurrency Safety), Rondo-STD-111 (Code Quality).
...
|-------------|--------|---------|
| Rondo spec from Rondo | `Rondo-SOP-100` or `Rondo-REQ-100` | "See Rondo-REQ-100 (Core)" |
| OB spec from Rondo | `OB-NN` or `OB-SOP-NNN` | "OB-SOP-100 defines build integration" |
| Caliber spec from Rondo | `Caliber Rondo-SOP-101` | "Caliber Rondo-SOP-101 defines the build flow" |
...
- If a spec is referenced by a build sprint but hasn't passed Phase 5 review, the build
  preflight (Rondo-SOP-101) should flag it: "Spec REQ-NNN not yet reviewed — build may fail."
...
1. Check existing specs for naming conventions (especially Rondo-STD-100, Rondo-REQ-100)
...
| Rondo-SOP-101 | Build procedure references spec readiness |
...
- The universal numbering system (001-019 reserved) ensures that when OB references
  "Rondo-STD-100" and Rondo references "Rondo-STD-100", they're the same topic.
