# Rondo-SOP-102: Release Procedure
...
**OUT scope:**
- Build process details (Rondo-SOP-101 owns that)
...
```
Pre-release checklist (Rondo-SOP-101 build gates)
    │
    ▼
...
|-------------|------|-------|
| Rondo-SOP-101 | Build gates must pass before release | Pre-release dependency |
...
| Depends On | Why |
|------------|-----|
| Rondo-SOP-101 | Build gates must pass (pre-release checklist) |
