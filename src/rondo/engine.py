...
class Task:  # pylint: disable=too-many-instance-attributes
    ...
    # -- structured input (REQ-119 req 001)
...
class TaskResult:  # pylint: disable=too-many-instance-attributes
    ...
    # -- structured input audit (REQ-119 req 002)
    context_data: dict[str, Any] = field(default_factory=dict)
...
def validate_task(
    ...
    *,
    ...
    # -- REQ-119 req 009: context_data must be JSON-serializable
    context_data_size = 0
    ...
    # -- REQ-119 req 005: context_data included in size cap
...
def _validate_context_files(
    ...
    REQ-119 req 005: combined context_files + context_data size checked.
    """
    errors: list[str] = []
    total_size = 0
...
# -- sig: mgh-6201.cd.bd955f.773b.b51eb1
