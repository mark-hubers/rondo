...
class TestDispatchEngineIntegration:
    ...
    def test_empty_model_inline_returns_plan(self) -> None:
        """RONDO-285: execution=inline returns host plan payload."""
    ...
    def test_inline_plan_has_schema(self) -> None:
        """RONDO-285: inline request in MCP path returns plan schema."""
        from rondo.mcp_server import rondo_run_file
...
class TestClaudeCodeInlineDispatch:
    ...
    def test_execution_auto_with_mcp_session_defaults_inline_plan(self) -> None:
        result = json.loads(
            rondo_run_file(
